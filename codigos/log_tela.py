import tkinter as tk #importando a biblioteca - necessário em todos os arquivos que mexem na interface -.
...
class Tela: #iniciando a classe.
    def __init__(self, master):
        ...
        self.log = tk.Frame(janela, width=200, height=300,) #inicio um frame pra comportar os elementos da tela de login. Usei por que acho que fica mais organizado, mas não é necessário.
    ...
    # Adicionando elementos no frame:
        self.lbl_user = tk.Label(self.log, text='Usuário:                                 ', font = ("Arial", 14)) # iniciei a label e usei essa quantidade de espaços pra ficar mais bonito visualmente.
        self.lbl_user.grid(row=0, column=0, columnspan=2, sticky="w") # posicionando a label
        self.user_ent = tk.Entry(self.log, bg='lightgray') # iniciando a entrada para receber a senha
        ...
        self.lbl_senha = tk.Label(self.log, text = 'Senha:', font = ("Arial", 14))
        self.lbl_senha.grid(row=2, column=0, sticky="w")
        self.ent_senha = tk.Entry(self.log, bg='lightgray')
